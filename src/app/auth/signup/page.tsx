...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(submissionError instanceof Error ? submissionError.message : 'Failed to create account');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <Card gradient className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-[#a7b4c8]">Start your journey with Looca</p>
          </div>
          ...
          {/* Google Sign Up */}
          <button type="button" className="w-full flex items-center justify-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10 text-white/60 cursor-not-allowed mb-6">
            ...
            Google sign-up needs backend setup
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-[#64748b]">
              ...
              <Link href="#" className="text-[#7cdbff] hover:underline">Terms</Link>
              {' '}and{' '}
              <Link href="#" className="text-[#7cdbff] hover:underline">Privacy Policy</Link>
            </p>
          ...
          <p className="text-center text-sm text-[#64748b] mt-6">
            ...
            <Link href="/auth/login" className="text-[#7cdbff] hover:underline font-medium">
              Sign in
            </Link>
          </p>
        </Card>
